...
pktgen.range.dst_ip("0", "min", "16.0.153.153");
pktgen.range.dst_ip("0", "max", "16.0.153.154");

pktgen.range.src_ip("0", "start", "48.0.153.153");
pktgen.range.src_ip("0", "inc", "0.0.0.1");
pktgen.range.src_ip("0", "min", "48.0.153.153");
pktgen.range.src_ip("0", "max", "48.0.153.154");
