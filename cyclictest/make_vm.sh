...
GUEST_NAME="cyclictest"
GUEST_DOMAIN=intranet.local
GUEST_VROOTDISKSIZE=8G
GUEST_VCPUS=4
GUEST_VMEM=4096
...
write_files:
  - path: /provision.sh
    content: |
      ...
      pip install numpy
      cd /home/ubuntu/cyclictest && git checkout stable/v1.0 && make cyclictest
      cp /home/ubuntu/cyclictest/cyclictest /home/ubuntu/hist-em
      mkdir /home/ubuntu/go-work && mkdir /home/ubuntu/go-work/src
      cp -R /home/ubuntu/hist-em /home/ubuntu/go-work/src/
      rm /home/ubuntu/go-work/src/hist-em/collector.go
      cd /home/ubuntu/go-work/src/hist-em && GOPATH=/home/ubuntu/go-work/src /home/ubuntu/go/bin/go get ./...
      cd /home/ubuntu/go-work/src/hist-em && GOPATH=/home/ubuntu/go-work/src /home/ubuntu/go/bin/go build 
     
  - path: /etc/init.d/cyclictest
    content: |
      #!/usr/bin/env bash
      sudo su
      cd /home/ubuntu/go-work/src/hist-em && sudo touch output.txt && sudo ./hist-em & 
...
runcmd:
  - bash /provision.sh
  - chmod +x /etc/init.d/cyclictest
  - update-rc.d cyclictest defaults
